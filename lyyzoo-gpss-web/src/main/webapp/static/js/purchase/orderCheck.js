...
var PurchaseOrder = {
    ...
    getGrid: function () {
        ...
        var store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url: CTX + '/admin/purchase/order/page?checkState=2',
                    ...
                    items: [
                        {
                            ...
                            handler: function (grid, rowIndex, colIndex, actionItem, event, record, row) {
                                var checkWin = PurchaseOrder.getCheckWin(record);
                                checkWin.show();
                            },
    ...
    getCheckWin: function (record) {
        ...
        if(!PurchaseOrder.checkWin){
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            if (form.isValid()) {
                                form.submit({
                                    url: CTX + '/admin/purchase/order/check',
                                    method: 'GET',
            ...
            PurchaseOrder.checkWin = checkWin;
        }

        PurchaseOrder.checkWin.form.getComponent('id').setValue(record.data.id);

        return PurchaseOrder.checkWin;
    }
};
